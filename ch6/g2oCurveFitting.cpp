...
public:
  ...
  virtual void linearizeOplus() override {
    ...
    _jacobianOplusXi[0] = -_x * _x * y;  // dy/da
    _jacobianOplusXi[1] = -_x * y;       // dy/db
...
int main(int argc, char **argv) {
  double ar = 1.0, br = 2.0, cr = 1.0;    // param_real
  double ae = 2.0, be = -1.0, ce = 5.0;   // param_estimation
  int N = 100;
  double w_sigma = 1.0;
