...
/// paths
string left_file = "/home/lb/vslam/mybook/ch8/left.png";
string disparity_file = "/home/lb/vslam/mybook/ch8/disparity.png";
boost::format fmt_others("/home/lb/vslam/mybook/ch8/%06d.png");  
...
int main(int argc, char **argv) {
    ...
    cout<< "image_size:" <<left_img.size()<<endl;
    ...
    int n_photos=6;
    for (int i = 1; i < n_photos; i++) { 
        cv::Mat img = cv::imread((fmt_others % i).str(), 0);
        cout << "T21 = \n" << endl;
        // use in two options < Single or Multi >
